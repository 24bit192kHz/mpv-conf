...
When using `mp.input.select`, the key bindings listed in [CONSOLE](manual-console-1.md) are
...
`g` listed in [Keyboard Control](manual-interactive-control-1.md). The names of the script bindings listed
