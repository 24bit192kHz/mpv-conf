...
-- value triggers script-message ar_subs_download_item <index>.

local H = require "harness"

local picker = require "ar_subs.ui.uosc_picker"
...
do
  ...
  H.eq("item 1 value command",
       menu.items[1].value,
       "script-message ar_subs_download_item 1")
  H.eq("item 2 value command",
       menu.items[2].value,
       "script-message ar_subs_download_item 2")
end
