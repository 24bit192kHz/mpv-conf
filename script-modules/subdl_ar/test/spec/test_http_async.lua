-- Spec: subdl_ar.http (async HTTP layer with rate-limit rotation)
--
-- Tests:
...
local http = require "subdl_ar.http"
...
do
  ...
  package.loaded["subdl_ar.http"] = nil
  local http_old = require "subdl_ar.http"
...
package.loaded["subdl_ar.http"] = _orig_http
